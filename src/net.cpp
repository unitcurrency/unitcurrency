...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("UniversalCurrency-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("UniversalCurrency-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("UniversalCurrency-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "UniversalCurrency " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"104.207.154.199", "104.207.154.199"},
 	{"103.22.181.2", "103.22.181.2"},
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("UniversalCurrency-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("UniversalCurrency-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("UniversalCurrency-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("UniversalCurrency-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. UniversalCurrency is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("UniversalCurrency-start");
